...
def parseArgs():
    ...
    parser.add_argument('--path1', nargs='?', default='CDRS/CoNet/Data/books_small/', type=str,
                        help='Input data path for domain1.')
    parser.add_argument('--path2', nargs='?', default='CDRS/CoNet/Data/elec_small/', type=str,
...
class CoNetRec(object):
    ...
    def data(self):
        ...
        def datasetProcess(self, dataset):
            ...
            dataset.train.shuffle(buffer_size=10**4)
