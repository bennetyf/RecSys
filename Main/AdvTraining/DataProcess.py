...
datapath_src = '/share/scratch/fengyuan/Projects/RecSys/Data/' + 'YahooMusic/Songs/ratings.csv'
datapath_save = '/share/scratch/fengyuan/Projects/RecSys/Data/' + 'YahooMusic/Filtered/ymus-345.csv'
datapath_mat = 'Data/ymus-345.mat'
########################################################################################################################
...
df = pd.read_csv(datapath_src, names=['uid','iid','ratings'], sep=',', engine='python')
