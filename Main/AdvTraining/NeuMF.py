...
class NeuMF(object):
    ...
    def build_model(self):
        with tf.variable_scope('Model',reuse=tf.AUTO_REUSE):
            ...
            gmf_output_vector = gmf_lf_vector_user * gmf_lf_vector_item
...
def parseArgs():
    ...
    parser.add_argument('--gmf_nfactors', type=int, default=50,
                        help='Embedding size.')
    parser.add_argument('--gmf_regs_embed', nargs='?', default='[0.0001,0.0001]', type=str,
                        help="Regularization constants for user and item embeddings.")

    parser.add_argument('--mlp_nfactors', type=int, default=50,
                        help='Embedding size.')
    parser.add_argument('--mlp_layers', nargs='?',type=str, default='[64,32]')
    parser.add_argument('--mlp_regs_layers', nargs='?',type=str,default='[0.1,0.1]')
    parser.add_argument('--mlp_regs_embed', nargs='?', default='[0.0001,0.0001]', type=str,
                        help="Regularization constants for user and item embeddings.")
    ...
    parser.add_argument('--ndcgk', default=[5,10],
                        help='The K value of the Top-K ranking list.')
    parser.add_argument('--num_rk', type=int, default=200,
