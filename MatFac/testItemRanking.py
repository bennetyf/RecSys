...
def parse_args():
    ...
    parser.add_argument('--model', choices=['CDAE','CML','NeuMF', 'GMF', 'MLP', 'BPRMF', 'JRL'], default = 'BPRMF')
...
if __name__ == '__main__':
    ...
    #train_data, test_data, n_user, n_item = load_data_neg(path="../Data/ml1m/1m_ratings.dat", test_size=0.2, sep="::")
